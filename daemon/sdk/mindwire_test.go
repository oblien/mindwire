...
func TestSDKRouteParity(t *testing.T) {
	...
	coverage := map[string]string{
		...
		"DELETE /surfaces/desktop/sessions/{id}":        "Surfaces.Close",
		"POST /surfaces/desktop/sessions/{id}/captures": "Surfaces.Capture",
		"POST /surfaces/desktop/actions":                "Surfaces.Action",
		...
		"GET /workspace/operations":                     "Workspace.Operations.List",
		"GET /workspace/operations/{id}":                "Workspace.Operations.Get",
		"GET /workspace/operations/{id}/stream":         "Workspace.Operations.Watch",
		"POST /workspace/operations/{id}/cancel":        "Workspace.Operations.Cancel",
		"POST /workspace/operations/{id}/retry":         "Workspace.Operations.Retry",
		"PUT /workspace/{kind}/{id}":                    "WorkspaceCollection.Put",
		"DELETE /workspace/{kind}/{id}":                 "WorkspaceCollection.Delete",
